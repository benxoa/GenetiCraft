...
const CreditStore = () => {
  ...
  const handleBuyNow = async (creditsToBuy) => {
    try {
      ...
      if (!userId || userId === undefined || userId === null) {
        ...
        const res = await fetch("https://geneticraft.fun:8080/api/purchase-credits", {
          method: "POST",
          headers: {
  ...
  const handlePayment = async () => {
    try {
      const paymentResponse = await fetch(
        "https://geneticraft.fun:8080/api/create-payment",
        {
          method: "POST",
        }
      );
  ...
  const createOrder_PRO = (data) => {
    return fetch("https://geneticraft.fun:8080/api/orders", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const onApprove_PRO = async (data) => {
    const res = await fetch(
      `https://geneticraft.fun:8080/api/orders/${data.orderID}/capture`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
